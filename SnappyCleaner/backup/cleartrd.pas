...
begin
  try
    ...
    begin
      ...
      ExProcess.Parameters.Add('-c');
      ExProcess.Parameters.Add('if [ -d "/home/' + ActUser[0] +
        '/.cache/moonchild productions" ]; then /usr/bin/rm -rf "/home/' + ActUser[0] +
        '/.cache/moonchild productions/"* "/home/' + ActUser[0] + '/.cache/moonchild productions/."*; fi;');
      ExProcess.Execute;
    end;
...
begin
  if MainForm.LangBtn.Caption = 'EN' then
    MainForm.StaticText1.Caption := 'очищаю кеш браузера Google Chrome, ждите...'
  else
...
begin
  if MainForm.LangBtn.Caption = 'EN' then
    MainForm.StaticText1.Caption := 'очищаю кеш браузера Opera, ждите...'
  else
...
begin
  if MainForm.LangBtn.Caption = 'EN' then
    MainForm.StaticText1.Caption := 'очищаю кеш браузера Chromium, ждите...'
  else
...
begin
  if MainForm.LangBtn.Caption = 'EN' then
    MainForm.StaticText1.Caption := 'очищаю кеш браузера PaleMoon, ждите...'
  else
