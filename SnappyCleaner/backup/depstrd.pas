...
type
  ...
  protected
  var
    ListTMP: TStringList; //Прототип списка с исключенными дубликатами и сортировкой
...
begin
  ...
  begin
    ...
    begin
      ...
      StaticText1.Caption := 'запущен анализ зависимостей пакета, ждите...';
    end
    else
    begin
...
begin
  ...
  begin
    ...
    if LangBtn.Caption = 'EN' then
      StaticText1.Caption := 'анализ зависимостей пакета завершен...'
    else
